...
class DecryptionEngineTest < MiniTest::Test
  ...
  def test_it_exists_with_attributes
    ...
    assert_instance_of DecryptionEngine, decrypter
  ...
  def test_it_can_make_terminal_tokens
    ...
    decrypter_3 = DecryptionEngine.new
  ...
  def test_it_will_decrypt_nothing_if_all_ciphers_added_are_zero_or_twenty_seven
    ...
    tokens = [12, 24, 18, 15, 0, 2, 4, 26]
    expected = "myspace "
    decrypter_4 = DecryptionEngine.new
  ...
  def test_its_class_can_return_a_cipher
    ...
    assert_equal "hello world!", DecryptionEngine.get_decryption(tokens, shifts)
  end
